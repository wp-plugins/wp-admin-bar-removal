...
remove_action('personal_options',$profileuser);
remove_filter('personal_options',$profileuser);
remove_action('personal_options',$profileuser->ID);
remove_filter('personal_options',$profileuser->ID);

...
<?php
	...
	function wpabr_hfl()
		{
			echo "\n<!--Plugin Admin Bar Removal 2013.0622-BUGFIX.0526-DEVELOPMENTAL Active - Tag: ".md5(md5("".""))."-->\n";

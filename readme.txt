...
Is planned compatibility update for WordPress 3.8+ / 3.9+ / 4.0+ / 4.1+ ? YES! The plugin that is updated for compatibility support with future WordPress releases is [WP ToolBar Removal](//wordpress.org/plugins/wp-toolbar-removal/) for now ... Please: migrate to it A.S.A.P.

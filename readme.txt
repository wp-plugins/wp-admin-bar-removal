...
Tags: wp, bar, removal, completely, disable, new, wordpress, 3.1, admin, frontend, remove, backend, user, code, beta1, beta2, RC1, RC2
Stable tag: 2011.0101.1111
...
Admin Bar Removal Completely <code>Disable</code> and <code>Remove</code> New WordPress 3.1 <code>Admin Bar</code> Frontend and Backend Code that now appears on the Public Side of new WordPress 3.1 based blogs for minimal memory load. Full 3.1-RC2 and Network Multisite compatible work with Shared and VPS Hosting.
...
== Changelog ==
`History Release's:
Development Release: Version 2010 Build 0102-BUGFIX Revision 0000
New Stable Release: Version 2011 Build 0101 Revision 1111
Last Stable Release: Version 2010 Build 1229 Revision 1656`
